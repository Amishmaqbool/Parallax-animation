...
const ScrollDrawing = () => {
  ...
  const [showLinesSecond, setShowLinesSecond] = useState(false);
  const [showLinesThird, setShowLinesThird] = useState(false);
  const [showLinesFourth, setShowLinesFourth] = useState(false);
  const [showLinesFifth, setShowLinesFifth] = useState(false);
  const [showLinesSixth, setShowLinesSixth] = useState(false);
  const [showLinesSeventh, setShowLinesSeventh] = useState(false);
  ...
  const textContent = [
    ".",
    "This would be the 'ideal' health curve.",
    "This is a real health curve with typical issues over a lifetime. Your real health curve is often impacted by disease and other conditions.",
    "This is a real health curve with typical issues over a lifetime. Your real health curve is often impacted by disease and other conditions.",
    "This is your lost health potential. Our purpose is to make the difference between these two lines as small as possible.",
    "Our program starts with assessing  your current  health status  to inform your  short-term treatment  plan.  When it comes  to  longer-term  health  risks, it is  all  about catching  these  early  with regular disease screenings.",
    "Based on your  current health status assessment we provide  concrete  treatment  recommendations  informed by  the latest  longevity  science  to  take  action. We  regularly  reassess to  understand  progress  and  finetune your  individual  longevity  plan.",
  ];
    ...
    if (currentStep < steps.length) {
      ...
      switch (currentState) {
        case "initial":
          setInitial(!initial);
          break;
        case "showLinesSecond":
          setShowLinesSecond(!showLinesSecond);
          break;
        case "showLinesThird":
          setShowLinesThird(!showLinesThird);
          break;
        case "showLinesFourth":
          setShowLinesFourth(!showLinesFourth);
          break;
        case "showLinesFifth":
          setShowLinesFifth(!showLinesFifth);
          break;
        case "showLinesSixth":
          setShowLinesSixth(!showLinesSixth);
          break;
        case "showLinesSeventh":
          setShowLinesSeventh(!showLinesSeventh);
          break;
        default:
          break;
      }
  ...
  return (
    <div className="bg-black h-[1200px] pt-">
      <div>
        <button
          className="bg-white p-4 ml-10 cursor-pointer hover:bg-gray-400 rounded-md absolute bottom-4 left-[45%]"
          onClick={toggleLines}
        >
          Scroll
        </button>
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          {initial && (
            <>
              <path
                d="M260.354 89.6464C260.158 89.4512 259.842 89.4512 259.646 89.6464L256.464 92.8284C256.269 93.0237 256.269 93.3403 256.464 93.5355C256.66 93.7308 256.976 93.7308 257.172 93.5355L260 90.7071L262.828 93.5355C263.024 93.7308 263.34 93.7308 263.536 93.5355C263.731 93.3403 263.731 93.0237 263.536 92.8284L260.354 89.6464ZM259.5 624L259.5 624.5L260.5 624.5L260.5 624L259.5 624ZM259.5 90L259.5 624L260.5 624L260.5 90L259.5 90Z"
                fill="#898B8D"
              />
              <path
                d="M859.354 624.354C859.549 624.158 859.549 623.842 859.354 623.646L856.172 620.464C855.976 620.269 855.66 620.269 855.464 620.464C855.269 620.66 855.269 620.976 855.464 621.172L858.293 624L855.464 626.828C855.269 627.024 855.269 627.34 855.464 627.535C855.66 627.731 855.976 627.731 856.172 627.535L859.354 624.354ZM261 623.5L260.5 623.5L260.5 624.5L261 624.5L261 623.5ZM859 623.5L261 623.5L261 624.5L859 624.5L859 623.5Z"
                fill="#898B8D"
              />
              ...
              {showLinesSecond && (
                <>
                  ...
                  <g mask="url(#mask1_14_5254)" className="animate-path">
                    ...
                    >
                      <path
                        d="M897.707 377.707C898.098 377.317 898.098 376.683 897.707 376.293L891.343 369.929C890.953 369.538 890.319 369.538 889.929 369.929C889.538 370.319 889.538 370.953 889.929 371.343L895.586 377L889.929 382.657C889.538 383.047 889.538 383.681 889.929 384.071C890.319 384.462 890.953 384.462 891.343 384.071L897.707 377.707ZM451 378L897 378L897 376L451 376L451 378Z"
                        fill="#F6F6F6"
                      />
                    </mask>
              ...
              {showLinesThird && (
                <>
                  <path
                    d="M261 109C289.373 128.209 367.604 151.143 418.83 151.143C469.836 151.143 497.732 142.977 522.685 170.008C537.551 186.115 537.695 203.811 551.825 207.362C571.615 212.322 582.66 180.496 598.326 184.946C619.618 190.985 609.419 252.628 638.624 283.644C666.965 313.731 674.873 280.534 710.424 305.601C717.214 310.228 730.155 322.746 739.5 350.5C749.945 381.519 755.178 445.631 765.604 475.861C786 535 787.547 577.153 790.856 623.093"
                    stroke="#FF7344"
              ...
              <path
                id="myPath"
                d="M260 222C240.827 222 221.842 225.776 204.128 233.114C186.415 240.451 170.32 251.205 156.762 264.762C143.205 278.32 132.451 294.415 125.114 312.128C117.776 329.842 114 348.827 114 368L115.138 368C115.138 348.976 118.885 330.139 126.165 312.564C133.445 294.988 144.115 279.019 157.567 265.567C171.019 252.115 186.988 241.445 204.564 234.165C222.139 226.885 240.976 223.138 260 223.138L260 222Z"
                stroke="#898B8D"
              />

              <rect
                class="animated-line line-delay-1"
                x="76.8164"
                y="184.109"
                width="259.206"
                height="1"
                transform="rotate(45 76.8164 184.109)"
                fill="#898B8D"
                fill-opacity="0.5"
              />

              <rect
                class="animated-line line-delay-2"
                x="35.957"
                y="238.109"
                width="258.824"
                height="1"
                transform="rotate(30 35.957 238.109)"
                fill="#898B8D"
                fill-opacity="0.5"
              />

              <rect
                class="animated-line line-delay-3"
                x="11.2578"
                y="301"
                width="257.51"
                height="1"
                transform="rotate(15 11.2578 301)"
                fill="#898B8D"
                fill-opacity="0.5"
              />

              <rect
                class="animated-line line-delay-4"
                x="3"
                y="367"
                width="257"
                height="1"
              ...
              <rect
                class="animated-line line-delay-5"
                x="11.4375"
                y="434.211"
                width="257.244"
                height="1"
                transform="rotate(-15 11.4375 434.211)"
                fill="#898B8D"
                fill-opacity="0.5"
              />

              <rect
                class="animated-line line-delay-6"
                x="37.2656"
                y="496.463"
                width="256.926"
                height="1"
                transform="rotate(-30 37.2656 496.463)"
                fill="#898B8D"
                fill-opacity="0.5"
              />

              <rect
                class="animated-line line-delay-7"
                x="79.0273"
                y="549.236"
                width="256.307"
                height="1"
                transform="rotate(-45 79.0273 549.236)"
                fill="#898B8D"
                fill-opacity="0.5"
              />
              ...
              <path
                d="M260.5 367C286.567 367 312.38 372.134 336.463 382.11C360.546 392.085 382.428 406.707 400.861 425.139C419.293 443.572 433.915 465.454 443.89 489.537C453.866 513.621 459 539.433 459 565.5L457.047 565.5C457.047 539.689 451.964 514.131 442.086 490.285C432.209 466.438 417.731 444.771 399.48 426.52C381.229 408.269 359.562 393.791 335.715 383.914C311.869 374.036 286.311 368.953 260.5 368.953L260.5 367Z"
                stroke="#898B8D"
                stroke-opacity="0.5"
                stroke-width="2"
                mask="url(#path-84-inside-1_14_5254)"
              />
              ...
              <path
                d="M459 565.5C459 591.567 453.866 617.38 443.89 641.463C433.915 665.546 419.293 687.428 400.861 705.861C382.428 724.293 360.546 738.915 336.463 748.89C312.379 758.866 286.567 764 260.5 764L260.5 762.047C286.311 762.047 311.869 756.964 335.715 747.086C359.562 737.209 381.229 722.731 399.48 704.48C417.731 686.229 432.209 664.562 442.086 640.715C451.964 616.869 457.047 591.311 457.047 565.5L459 565.5Z"
                stroke="#898B8D"
                stroke-opacity="0.5"
                stroke-width="2"
                mask="url(#path-85-inside-2_14_5254)"
              />
              <mask id="path-86-inside-3_14_5254" fill="white">
                <path d="M260.5 764C234.433 764 208.62 758.866 184.537 748.89C160.454 738.914 138.572 724.293 120.139 705.861C101.707 687.428 87.0855 665.546 77.1099 641.463C67.1344 617.379 62 591.567 62 565.5L63.9526 565.5C63.9526 591.311 69.0365 616.869 78.9139 640.715C88.7913 664.562 103.269 686.229 121.52 704.48C139.771 722.731 161.438 737.209 185.285 747.086C209.131 756.964 234.689 762.047 260.5 762.047L260.5 764Z" />
              </mask>

              <path
                d="M260.5 764C234.433 764 208.62 758.866 184.537 748.89C160.454 738.914 138.572 724.293 120.139 705.861C101.707 687.428 87.0855 665.546 77.1099 641.463C67.1344 617.379 62 591.567 62 565.5L63.9526 565.5C63.9526 591.311 69.0365 616.869 78.9139 640.715C88.7913 664.562 103.269 686.229 121.52 704.48C139.771 722.731 161.438 737.209 185.285 747.086C209.131 756.964 234.689 762.047 260.5 762.047L260.5 764Z"
                stroke="#898B8D"
                stroke-opacity="0.5"
                stroke-width="2"
                mask="url(#path-86-inside-3_14_5254)"
              />
              <path
                d="M0.699188 366C0.699187 399.947 7.3855 433.561 20.3763 464.924C33.3672 496.286 52.4081 524.783 76.4121 548.787C100.416 572.791 128.913 591.832 160.276 604.823C191.638 617.814 225.253 624.5 259.199 624.5L259.199 622.798C225.476 622.798 192.083 616.156 160.927 603.25C129.771 590.345 101.462 571.429 77.6157 547.584C53.7698 523.738 34.8542 495.428 21.9489 464.272C9.04355 433.116 2.40127 399.723 2.40128 366L0.699188 366Z"
                fill="#898B8D"
                fill-opacity="0.5"
              />
              <path
                d="M259.5 107C225.553 107 191.939 113.686 160.576 126.677C129.214 139.668 100.717 158.709 76.7129 182.713C52.7089 206.717 33.6679 235.214 20.6771 266.576C7.68626 297.939 0.99997 331.553 0.999977 365.5L2.70206 365.5C2.70206 331.777 9.34433 298.384 22.2496 267.228C35.1549 236.072 54.0705 207.762 77.9164 183.916C101.762 160.071 130.071 141.155 161.228 128.25C192.384 115.344 225.777 108.702 259.5 108.702L259.5 107Z"
                fill="#898B8D"
                fill-opacity="0.5"
              />
            </>
          ...
          {showLinesSeventh && (
            <>
              ...
              >
                <path
                  d="M260.707 287.293C260.317 286.902 259.683 286.902 259.293 287.293L252.929 293.657C252.538 294.047 252.538 294.681 252.929 295.071C253.319 295.462 253.953 295.462 254.343 295.071L260 289.414L265.657 295.071C266.047 295.462 266.681 295.462 267.071 295.071C267.462 294.681 267.462 294.047 267.071 293.657L260.707 287.293ZM261 625L261 288L259 288L259 625L261 625Z"
                  fill="#F6F6F6"
                  className="animate-top"
                />
              </mask>
              <g mask="url(#mask0_14_5254)" className="animate-top">
                <rect
                  x="252"
                  y="287.8"
                  width="16"
          ...
          {showLinesSixth && (
            <>
              ...
              >
                <path
                  d="M707.707 624.707C708.098 624.317 708.098 623.683 707.707 623.293L701.343 616.929C700.953 616.538 700.319 616.538 699.929 616.929C699.538 617.319 699.538 617.953 699.929 618.343L705.586 624L699.929 629.657C699.538 630.047 699.538 630.681 699.929 631.071C700.319 631.462 700.953 631.462 701.343 631.071L707.707 624.707ZM261 625L707 625L707 623L261 623L261 625Z"
                  fill="#F6F6F6"
                  className="animate-left"
                />
              </mask>

              <g mask="url(#mask3_14_5254)" className="animate-left">
                <rect
                  x="710"
                  y="609"
                  width="30"
                  height="450"
                  transform="rotate(90 710 609)"
                  fill="#D9D9D9"
                />
              </g>
          ...
          >
            <path
              d="M260 108H581C730.117 108 851 228.883 851 378V623.5"
              stroke="#C7CD8E"
            />
          </mask>
        </svg>
        {currentStep < textContent.length && (
          <div className="max-w-[300px]">
            <p className="text-red-600 font-[20px] font-bold">
      ...
      <div className="flex justify-center py-4">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M0.5 34H1788.5" stroke="#FF7344" id="ProgressBar" />
          ...
          <path
            className="progress-initial"
            d="M270 48.1878L270 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-initial"
            d="M323 48.1878L323 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-initial"
            d="M535 48.1878L535 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-initial"
            d="M800 48.1878L800 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-initial"
            d="M1065 48.1878L1065 28.6832"
            stroke="#B7B7B7"
          />
          ...
          <path
            className="progress-second"
            d="M1330 48.1878L1330 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-second"
            d="M588 48.1878L588 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-second"
            d="M853 48.1878L853 28.6832"
            stroke="#B7B7B7"
          />

          {/* Third Progress */}
          <path
            className="progress-third"
            d="M747 48.1879V0"
            stroke="#B7B7B7"
          />
          <path
            className="progress-third"
            d="M1118 48.1878L1118 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-third"
            d="M1383 48.1878L1383 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-third"
            d="M376 48.1878L376 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-third"
            d="M641 48.1878L641 28.6832"
            stroke="#B7B7B7"
          />

          {/* Fourth Progress */}
          <path
            className="progress-fourth"
            d="M1012 48.1879V0"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fourth"
            d="M906 48.1878L906 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fourth"
            d="M1171 48.1878L1171 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fourth"
            d="M1436 48.1878L1436 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fourth"
            d="M429 48.1878L429 28.6832"
            stroke="#B7B7B7"
          />

          {/* Fifth Progress */}
          <path
            className="progress-fifth"
            d="M1277 48.1879V0"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fifth"
            d="M694 48.1878L694 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fifth"
            d="M959 48.1878L959 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fifth"
            d="M1224 48.1878L1224 28.6832"
            stroke="#B7B7B7"
          />
          <path
            className="progress-fifth"
            d="M1489 48.1878L1489 28.6832"
            stroke="#B7B7B7"
          />

          {/* Last Progress */}
          <path
            className="progress-sixth"
            d="M1542 48.1879V0"
            stroke="#B7B7B7"
          />
        </svg>
